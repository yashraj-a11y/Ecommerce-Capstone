...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation */}
      <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-[60] ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
        ...
        <div className="p-4">
          ...
          <nav className="space-y-4">
            ...
            <Link to='/collections/all?category=Top wear' onClick={toggleNavDrawer} className="block text-gray-600 hover:text-black">TopWear</Link>
            <Link to='/collections/all?category=Bottom Wear' onClick={toggleNavDrawer} className="block text-gray-600 hover:text-black">BottomWear</Link>
          </nav>
